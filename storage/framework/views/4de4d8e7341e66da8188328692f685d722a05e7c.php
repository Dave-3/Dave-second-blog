...
<div class="container">
    <div>
        <form action="<?php echo e(route('add-story')); ?>" method="post"  enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
            <p>Title</p>
...
<?php /**PATH /var/www/html/dave-second/resources/views/home.blade.php ENDPATH**/ ?>